...
class NumberGenerator(object):
	'''
	A class that implements a number generator that uses the RandomPool class from this module
	'''
	def __init__(self):
		super(NumberGenerator, self).__init__() # superclass python 3 style
